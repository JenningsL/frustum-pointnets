...
TRAIN_DATASET = AvodDataset(NUM_POINT, '/data/ssd/public/jlliu/Kitti/object', BATCH_SIZE, 'train',
             save_dir='/data/ssd/public/jlliu/experiment/frustum-pointnets/train/avod_dataset_car_people_rgb_gt/train',
...
TEST_DATASET = AvodDataset(NUM_POINT, '/data/ssd/public/jlliu/Kitti/object', BATCH_SIZE, 'val',
             save_dir='/data/ssd/public/jlliu/experiment/frustum-pointnets/train/avod_dataset_car_people_rgb_gt/val',
