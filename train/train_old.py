...
TRAIN_DATASET = provider.FrustumDataset(npoints=NUM_POINT, split='train',
    overwritten_data_path='/data/ssd/public/jlliu/frustum-pointnets/avod_prop/frustum_caronly_train%s.pickle'%FLAGS.pickle,
    rotate_to_center=True, random_flip=False, random_shift=True, extra_feature=True)
TEST_DATASET = provider.FrustumDataset(npoints=NUM_POINT, split='val',
    overwritten_data_path='/data/ssd/public/jlliu/frustum-pointnets/avod_prop/frustum_caronly_val%s.pickle'%FLAGS.pickle,
